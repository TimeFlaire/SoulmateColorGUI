...
GREECE["1"].Active = false
GREECE["1"].AnchorPoint = Vector2.new(1, 0)
GREECE["1"].BackgroundColor3 = Color3.fromRGB(255, 255, 255)
...
GREECE["6"].ClipsDescendants = false
...
--[[
    Scripts
--]]
-- Require GREECE wrapper
local GREECE_REQUIRE = require;
local GREECE_MODULES = {};
local function require(Module:ModuleScript)
    local ModuleState = GREECE_MODULES[Module];
    if ModuleState then
    ...
    return GREECE_REQUIRE(Module);
end

return GREECE["0"], require;
